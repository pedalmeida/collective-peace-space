      ...
      <div className="container max-w-2xl text-center relative z-10">
        ...
        <motion.div
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="group inline-flex items-center gap-2.5 px-6 rounded-full border-2 border-accent/30 bg-gradient-to-r from-accent/5 to-accent/15 text-accent text-sm font-semibold tracking-wide hover:border-accent/60 hover:shadow-lg hover:shadow-accent/10 transition-all duration-300 mb-6 -mt-3 py-[15px] my-[14px]">
