...
Queres receber informação sobre próximos eventos? Junta-te à Comunidade do WhatsApp ou contacta-nos.
        ...
        <motion.div initial={{ opacity: 0, y: 20, filter: "blur(4px)" }} whileInView={{ opacity: 1, y: 0, filter: "blur(0px)" }} viewport={{ once: true, amount: 0.2 }}
        ...
        <motion.div
          ...
          <p className="text-sm text-muted-foreground">
            Ou junta-te à nossa comunidade WhatsApp para acompanhar as novidades e os próximos eventos.
          </p>
          <a
            href="https://chat.whatsapp.com/F8bensGlhy8EHGsQpS4I2u"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg border border-border bg-card text-foreground text-sm font-medium hover:bg-accent/10 transition-colors duration-200">
